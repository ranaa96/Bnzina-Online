/* Rainbow v2.1.3 rainbowco.de | included languages: c, coffeescript, csharp, css, d, generic, go, haskell, html, java, javascript, json, lua, php, python, r, ruby, scheme, shell, smalltalk, sql */ ! function (e, t) {
	...
	function c(t, Prism) {
		...
		var n = Prism.toString(),
			c = u.toString();
		c += a.toString(), c += r.toString(), c += i.toString(), c += s.toString(), c += o.toString(), c += n;
	...
	function b(e, t) {
		...
		for (var n = e.getElementsByTagName("pre"), r = e.getElementsByTagName("code"), a = [], o = [], i = 0, u = n; i < u.length; i += 1) {
			var s = u[i];
			h(s), s.getElementsByTagName("code").length ? s.getAttribute("data-trimmed") || (s.setAttribute("data-trimmed", !0), s.innerHTML = s.innerHTML.trim()) : a.push(s)
		}
	...
	var M, Prism = function Prism(e) {
			...
			function l(r, a, i) {
				function c(e) {
					return r.name && (e = n(r.name, e)), p[y] = {
						replace: m[0],
						"with": e
					}, h[y] = w, !g && {
				...
				function l(t) {
					...
					if (a) {
						...
						l = d.refract(a, v, c.length ? c : [c]), f(a, l, i.matches ? i.name : 0)
					}
				}
				void 0 === i && (i = 0);
				var d = r.pattern;
...
Rainbow.extend("c", [{
...
}]), Rainbow.addAlias("scss", "css"), Rainbow.extend("d", [{
	name: "constant",
	...
	pattern: /(func)\s+(.*?)(?=\()/g
}], "generic"), Rainbow.extend("haskell", [{
	name: "comment",
	pattern: /\{\-\-[\s\S(\w+)]+[\-\-][\}$]/gm
}, {
	name: "comment",
